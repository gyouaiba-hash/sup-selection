...
if st.button("運命の抽選スタート！", type="primary"):
    if edited_df.empty:
        ...
        # --- 納得感のためのグラフ表示 ---
        st.markdown("### 📊 なぜこの順位になったのか？（内訳）")
        st.caption("青色＝練習回数、赤色＝運要素。赤色がプラスの人はラッキー、マイナスの人はアンラッキーです。")
        
        # グラフ用にデータを整形
        chart_data = result_df.set_index("名前")[["練習回数(実力)", "運ボーナス"]]
